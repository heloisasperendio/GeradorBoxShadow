class BoxShadowGenerator {
    ...
    applyRule(){
        ...
        console.log(this.insetyRef)

        const shadowRule = `${this.insetyRef ? "inset" : ""} ${this.horizontalRef.value}px ${this.verticalRef.value}px ${this.blurRef.value}px ${this.spreadRef.value}px rgba(${rgbValue}, ${this.opacityRef.value})`
